...
from services.database import get_achievements, get_sim_overall, unlock_achievement
...
ACHIEVEMENTS = [
    ...
    {"id": "hundred_fifty", "title": "Coleccionista avanzado", "desc": "Consigue 150 figuritas", "icon": "📚", "type": "count", "value": 150},
    {"id": "two_hundred", "title": "Colección seria", "desc": "Consigue 200 figuritas", "icon": "🏅", "type": "count", "value": 200},
    {"id": "three_hundred", "title": "Coleccionista experto", "desc": "Consigue 300 figuritas", "icon": "📦", "type": "count", "value": 300},
    {"id": "four_hundred", "title": "Maestro del álbum", "desc": "Consigue 400 figuritas", "icon": "🗂️", "type": "count", "value": 400},
    {"id": "five_hundred", "title": "Casi imparable", "desc": "Consigue 500 figuritas", "icon": "🎯", "type": "count", "value": 500},
    ...
    {"id": "album_complete", "title": "Álbum completo", "desc": "Completa todo el álbum", "icon": "🏆", "type": "count", "value": TOTAL_STICKERS},
    # --- Simulación de partidos ---
    {"id": "sim_debut", "title": "Debut en la cancha", "desc": "Jugá tu primer partido simulado", "icon": "🟢", "type": "sim_played", "value": 1},
    {"id": "sim_first_win", "title": "Primera victoria", "desc": "Ganá tu primer partido simulado", "icon": "🥅", "type": "sim_wins", "value": 1},
    {"id": "sim_five_wins", "title": "En racha", "desc": "Ganá 5 partidos simulados", "icon": "🔥", "type": "sim_wins", "value": 5},
    {"id": "sim_ten_played", "title": "Habitué", "desc": "Jugá 10 partidos simulados", "icon": "🎮", "type": "sim_played", "value": 10},
    {"id": "sim_fifteen_wins", "title": "Goleador", "desc": "Ganá 15 partidos simulados", "icon": "⚽", "type": "sim_wins", "value": 15},
    {"id": "sim_thirty_wins", "title": "Campeón de la simulación", "desc": "Ganá 30 partidos simulados", "icon": "🏆", "type": "sim_wins", "value": 30},
]
